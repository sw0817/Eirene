...
public class MotionPurple : MonoBehaviour
{
    GameObject userInfo;
    string userId;
    ...
    void HandleValueChanged(object sender, ValueChangedEventArgs args)
    {
        ...
        if (msg == "hand".ToString() || msg == "clap".ToString())
        {
            Collecting.StartCollect();
            // MotionOpenMenu.MotionOpen(targetCanvas);
        }
        if (msg == "hurray".ToString())
        {
            Collecting.StartCollect();
            // MotionOpenMenu.MotionOpen(targetCanvas);
        }
