...
{
    private string nickname; // 일단 하드코딩
    GameObject userInfo;
    ...
    private void Start() // photon cloud 서버이자 matchmaking 위함
    {
        ...
        nickname = userInfo.GetComponent<SaveLoginInfo>().loginNickname;
        ...
        Debug.Log(connectionInfoText.text);
    }
    ...
    public override void OnJoinRandomFailed(short returnCode, string message)
    {
        ...
        PhotonNetwork.CreateRoom(null, new RoomOptions {MaxPlayers = 5}); // 새로운 룸 만들기 (최대 20명)
        Debug.Log(connectionInfoText.text);
    }
